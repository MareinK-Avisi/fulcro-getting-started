...
var len__4730__auto___55762 = arguments.length;
var i__4731__auto___55763 = (0);
while(true){
if((i__4731__auto___55763 < len__4730__auto___55762)){
args__4736__auto__.push((arguments[i__4731__auto___55763]));

var G__55764 = (i__4731__auto___55763 + (1));
i__4731__auto___55763 = G__55764;
continue;
} else {
}
break;
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.data_targeting.multiple_targets.cljs$lang$applyTo = (function (seq55619){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55619));
}));
...
var args__4736__auto__ = [];
var len__4730__auto___55775 = arguments.length;
var i__4731__auto___55776 = (0);
while(true){
if((i__4731__auto___55776 < len__4730__auto___55775)){
args__4736__auto__.push((arguments[i__4731__auto___55776]));

var G__55778 = (i__4731__auto___55776 + (1));
i__4731__auto___55776 = G__55778;
continue;
} else {
}
break;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (state__$1,p__55665){
var vec__55667 = p__55665;
var command = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55667,(0),null);
var data_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55667,(1),null);
var already_has_ident_at_path_QMARK_ = (function (data_path__$1){
return cljs.core.some((function (p1__55650_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__55650_SHARP_,ident);
}),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(state__$1,data_path__$1));
});
var G__55673 = command;
var G__55673__$1 = (((G__55673 instanceof cljs.core.Keyword))?G__55673.fqn:null);
switch (G__55673__$1) {
case "prepend":
if(cljs.core.truth_(already_has_ident_at_path_QMARK_(data_path))){
return state__$1;
} else {
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state__$1,data_path,(function (p1__55652_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [ident], null),p1__55652_SHARP_);
}));
}
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$lang$applyTo = (function (seq55658){
var G__55659 = cljs.core.first(seq55658);
var seq55658__$1 = cljs.core.next(seq55658);
var G__55660 = cljs.core.first(seq55658__$1);
var seq55658__$2 = cljs.core.next(seq55658__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55659,G__55660,seq55658__$2);
}));
...
if(com.fulcrologic.fulcro.algorithms.data_targeting.special_target_QMARK_(target__$1)){
var G__55753 = state_map__$1;
var G__55753__$1 = ((com.fulcrologic.fulcro.algorithms.data_targeting.prepend_target_QMARK_(target__$1))?com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__55753,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prepend","prepend",342616040),target__$1], 0)):G__55753);
var G__55753__$2 = ((com.fulcrologic.fulcro.algorithms.data_targeting.append_target_QMARK_(target__$1))?com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__55753__$1,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"append","append",-291298229),target__$1], 0)):G__55753__$1);
if(com.fulcrologic.fulcro.algorithms.data_targeting.replacement_target_QMARK_(target__$1)){
return com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__55753__$2,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"replace","replace",-786587770),target__$1], 0));
} else {
return G__55753__$2;
}
} else {
...
var G__55756 = process_target_impl(state_map,source_path,target);
...
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__55756,source_path);
} else {
return G__55756;
}
}));
