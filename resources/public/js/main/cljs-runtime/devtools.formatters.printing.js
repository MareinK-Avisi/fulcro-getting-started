...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42204){
var G__42205 = cljs.core.first(seq42204);
var seq42204__$1 = cljs.core.next(seq42204);
var G__42206 = cljs.core.first(seq42204__$1);
var seq42204__$2 = cljs.core.next(seq42204__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42205,G__42206,seq42204__$2);
}));
...
if(cljs.core.truth_((function (){var or__4120__auto__ = devtools.formatters.helpers.directly_printable_QMARK_(value);
if(or__4120__auto__){
...
(devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__4363__auto__,writer__4364__auto__,opt__4365__auto__){
return cljs.core._write(writer__4364__auto__,"devtools.formatters.printing/TemplateWriter");
}));
...
if(cljs.core.truth_(((cljs.core.not(devtools.formatters.printing.already_reference_QMARK_(group)))?(function (){var or__4120__auto__ = devtools.formatters.helpers.expandable_QMARK_(obj);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42234_SHARP_){
return (!((cljs.core.meta(p1__42234_SHARP_) == null)));
})))){
...
var map__42256 = opts;
var map__42256__$1 = (((((!((map__42256 == null))))?(((((map__42256.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42256.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42256):map__42256);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42256__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__4120__auto__ = (function (){try{if((!((obj == null)))){
...
}catch (e42261){var _e__40683__auto__ = e42261;
return false;
}})();
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
...
}catch (e42263){var _e__40683__auto__ = e42263;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42266 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42267 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42267);

try{var map__42271 = opts;
var map__42271__$1 = (((((!((map__42271 == null))))?(((((map__42271.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42271.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42271):map__42271);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42271__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42266);
}});
...
var temp__5733__auto___42302 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42302)){
var managed_print_level_42303 = temp__5733__auto___42302;
var _STAR_print_level_STAR__orig_val__42275_42304 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42276_42305 = managed_print_level_42303;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42276_42305);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42273_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42273_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42275_42304);
}} else {
job_fn();
}
