...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_42906 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_42906(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_42914 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_42914(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42919 = (function (reader,ch){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42919(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42920 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42920(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42922 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42922(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42931 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42931(reader);
}
});
...
var G__43024 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__43025 = s.append(c);
c = G__43024;
s = G__43025;
continue;
}
