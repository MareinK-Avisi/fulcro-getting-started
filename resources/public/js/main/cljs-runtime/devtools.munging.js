...
var o40777 = temp__5733__auto__;
var temp__5733__auto____$1 = (o40777["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o40778 = temp__5733__auto____$1;
return (o40778["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40671__auto__ = f;
return (o__40671__auto__["toString"]).call(o__40671__auto__);
} else {
return "";
}
}catch (e40787){var _ = e40787;
return "";
}});
...
try{var o__40671__auto___41437 = t;
(o__40671__auto___41437["cljs$lang$ctorPrWriter"]).call(o__40671__auto___41437,t,writer);
}catch (e40798){var __41439 = e40798;
}
...
var char_code = (function (){var o__40671__auto__ = (new String(char$));
return (o__40671__auto__["charCodeAt"]).call(o__40671__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40671__auto__ = String;
return (o__40671__auto__["fromCharCode"]).call(o__40671__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40814 = num_code;
switch (G__40814) {
case (1):
return (185);
...
var o__40671__auto__ = String;
return (o__40671__auto__["fromCharCode"]).call(o__40671__auto__,superscript_code);
});
/**
...
}catch (e40831){var _e__40683__auto__ = e40831;
return false;
}})())){
...
var vec__40833 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40833,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o40851 = temp__5733__auto__;
var temp__5733__auto____$1 = (o40851["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o40852 = temp__5733__auto____$1;
return (o40852["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40873){
var vec__40874 = p__40873;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40874,(0),null);
...
var G__41467 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41468 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41467;
remaining_tokens = G__41468;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40863){
var G__40865 = cljs.core.first(seq40863);
var seq40863__$1 = cljs.core.next(seq40863);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40865,seq40863__$1);
}));
...
var vec__40893 = cljs.core.split_with((function (p1__40888_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40888_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40893,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40893,(1),null);
...
var vec__40905 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40905,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40905,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__41475 = cljs.core.rest(remaining_tokens);
var G__41476 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41475;
name_tokens = G__41476;
continue;
} else {
...
var vec__40923 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40923,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40923,(1),null);
var vec__40926 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40926,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40926,(1),null);
var vec__40929 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40929,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40929,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40929,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40929,(3),null);
...
var vec__40979 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40979,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40979,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40979,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40979,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40979,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40979,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__40992 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40992,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40992,(1),null);
var vec__40999 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40999,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40999,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41019 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41019) : devtools.munging.parse_fn_info_deep.call(null,G__41019));
})()));
}
} else {
return fn_info;
...
var G__41540 = (arity + (1));
var G__41541 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41092){
var vec__41093 = p__41092;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41093,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41093,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41140_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41140_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41142_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41142_SHARP_);
}),sorted_infos);
...
var args__4736__auto__ = [];
var len__4730__auto___41568 = arguments.length;
var i__4731__auto___41572 = (0);
while(true){
if((i__4731__auto___41572 < len__4730__auto___41568)){
args__4736__auto__.push((arguments[i__4731__auto___41572]));

var G__41574 = (i__4731__auto___41572 + (1));
i__4731__auto___41572 = G__41574;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41185){
var vec__41188 = p__41185;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41188,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41169){
var G__41170 = cljs.core.first(seq41169);
var seq41169__$1 = cljs.core.next(seq41169);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41170,seq41169__$1);
}));
...
var map__41268__$1 = (((((!((map__41268 == null))))?(((((map__41268.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41268.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41268):map__41268);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41268__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41268__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41268__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41268__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41270 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41270,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41270,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41270,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41270,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41270,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41270,(5),null);
...
var o__40671__auto__ = f;
return (o__40671__auto__["getBasis"]).call(o__40671__auto__);
});
/**
...
}catch (e41296){var _e__40683__auto__ = e41296;
...
var G__41646 = (obj[cljs.core.first(path)]);
var G__41647 = cljs.core.rest(path);
obj = G__41646;
path = G__41647;
continue;
} else {
...
var _STAR_ = (function (accum,p__41347){
var vec__41348 = p__41347;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41348,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41348,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41376){
var vec__41379 = p__41376;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41379,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41379,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41379,(2),null);
...
var post_process = (function (p__41407){
var vec__41409 = p__41407;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41409,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41409,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41395_SHARP_){
return (obj[cljs.core.first(p1__41395_SHARP_)]);
}),sorted_matches);
