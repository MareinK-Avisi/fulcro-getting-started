...
com.fulcrologic.fulcro.dom_common.get_tokens = (function com$fulcrologic$fulcro$dom_common$get_tokens(k){
...
var id = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__59796_SHARP_){
return cljs.core.re_matches(/^#.*/,p1__59796_SHARP_);
}),tokens));
var classes = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__59797_SHARP_){
return cljs.core.re_matches(/^\..*/,p1__59797_SHARP_);
}),tokens);
...
var G__59805 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(com.fulcrologic.fulcro.dom_common.remove_separators,classes))], null);
if(cljs.core.truth_(sanitized_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__59805,new cljs.core.Keyword(null,"id","id",-1388402092),sanitized_id);
} else {
return G__59805;
}
} else {
 ...
 */
com.fulcrologic.fulcro.dom_common.combined_classes = (function com$fulcrologic$fulcro$dom_common$combined_classes(classes_seq,classes_str){
...
var map__59838 = com.fulcrologic.fulcro.dom_common.parse(kw);
var map__59838__$1 = (((((!((map__59838 == null))))?(((((map__59838.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__59838.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__59838):map__59838);
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__59838__$1,new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.PersistentVector.EMPTY);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59838__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var G__59846 = (function (){var or__4120__auto__ = props;
...
com.fulcrologic.fulcro.dom_common.classes__GT_str = (function com$fulcrologic$fulcro$dom_common$classes__GT_str(classes){
...
return new cljs.core.Keyword(null,"classes","classes",2037804510).cljs$core$IFn$_invoke$arity$1(com.fulcrologic.fulcro.dom_common.parse(entry));
} else {
...
var strcls = (function (){var or__4120__auto__ = new cljs.core.Keyword(null,"className","className",-1983287057).cljs$core$IFn$_invoke$arity$1(props);
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
return "";
...
//# sourceMappingURL=com.fulcrologic.fulcro.dom_common.js.map
