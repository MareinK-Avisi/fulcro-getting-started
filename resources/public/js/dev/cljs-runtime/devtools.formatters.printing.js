...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41714){
var G__41715 = cljs.core.first(seq41714);
var seq41714__$1 = cljs.core.next(seq41714);
var G__41716 = cljs.core.first(seq41714__$1);
var seq41714__$2 = cljs.core.next(seq41714__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41715,G__41716,seq41714__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41736_SHARP_){
return (!((cljs.core.meta(p1__41736_SHARP_) == null)));
})))){
...
var map__41747 = opts;
var map__41747__$1 = (((((!((map__41747 == null))))?(((((map__41747.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41747.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41747):map__41747);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41747__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41751){var _e__40325__auto__ = e41751;
return false;
}})();
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
...
}catch (e41754){var _e__40325__auto__ = e41754;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41756 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41757 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41757);

try{var map__41762 = opts;
var map__41762__$1 = (((((!((map__41762 == null))))?(((((map__41762.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41762.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41762):map__41762);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41762__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41756);
}});
...
var temp__5733__auto___41821 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___41821)){
var managed_print_level_41825 = temp__5733__auto___41821;
var _STAR_print_level_STAR__orig_val__41771_41826 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41772_41827 = managed_print_level_41825;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41772_41827);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41767_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41767_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41771_41826);
}} else {
job_fn();
}
