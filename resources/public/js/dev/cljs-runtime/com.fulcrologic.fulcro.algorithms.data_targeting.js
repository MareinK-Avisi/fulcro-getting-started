...
var len__4730__auto___56171 = arguments.length;
var i__4731__auto___56173 = (0);
while(true){
if((i__4731__auto___56173 < len__4730__auto___56171)){
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.data_targeting.multiple_targets.cljs$lang$applyTo = (function (seq55945){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55945));
}));
...
var G__56197 = (i__4731__auto___56194 + (1));
i__4731__auto___56194 = G__56197;
continue;
} else {
}
break;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (state__$1,p__56025){
var vec__56026 = p__56025;
var command = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56026,(0),null);
var data_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56026,(1),null);
var already_has_ident_at_path_QMARK_ = (function (data_path__$1){
return cljs.core.some((function (p1__56010_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__56010_SHARP_,ident);
}),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(state__$1,data_path__$1));
});
var G__56029 = command;
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state__$1,data_path,(function (p1__56011_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [ident], null),p1__56011_SHARP_);
}));
}
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$lang$applyTo = (function (seq56012){
var G__56013 = cljs.core.first(seq56012);
var seq56012__$1 = cljs.core.next(seq56012);
var G__56014 = cljs.core.first(seq56012__$1);
var seq56012__$2 = cljs.core.next(seq56012__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56013,G__56014,seq56012__$2);
}));
...
if(com.fulcrologic.fulcro.algorithms.data_targeting.special_target_QMARK_(target__$1)){
var G__56154 = state_map__$1;
var G__56154__$1 = ((com.fulcrologic.fulcro.algorithms.data_targeting.prepend_target_QMARK_(target__$1))?com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__56154,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prepend","prepend",342616040),target__$1], 0)):G__56154);
var G__56154__$2 = ((com.fulcrologic.fulcro.algorithms.data_targeting.append_target_QMARK_(target__$1))?com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__56154__$1,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"append","append",-291298229),target__$1], 0)):G__56154__$1);
if(com.fulcrologic.fulcro.algorithms.data_targeting.replacement_target_QMARK_(target__$1)){
return com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__56154__$2,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"replace","replace",-786587770),target__$1], 0));
} else {
return G__56154__$2;
}
} else {
...
var G__56160 = process_target_impl(state_map,source_path,target);
...
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__56160,source_path);
} else {
return G__56160;
}
}));
