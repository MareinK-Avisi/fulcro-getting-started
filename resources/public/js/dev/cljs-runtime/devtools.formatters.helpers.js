...
var G__41705 = devtools.prefs.pref(v);
v = G__41705;
continue;
} else {
return v;
...
}catch (e41654){var _e__40325__auto__ = e41654;
return false;
}})();
...
}catch (e41665){var _e__40325__auto__ = e41665;
return false;
}})();
...
}catch (e41671){var _e__40325__auto__ = e41671;
return false;
}}
}
});
...
var vec__41684 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41684,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41684,(1),null);
...
return cljs.core.some((function (p1__41687_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41687_SHARP_);
}),template);
});
