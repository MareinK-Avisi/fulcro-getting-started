 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__55953){
var vec__55955 = p__55953;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55955,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55955,(1),null);
var ref = vec__55955;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__55966){
var vec__55968 = p__55966;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55968,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55968,(1),null);
var ref = vec__55968;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__55982){
var map__55983 = p__55982;
var map__55983__$1 = (((((!((map__55983 == null))))?(((((map__55983.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55983.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55983):map__55983);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55983__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__56001,entity,state_map,parent_node,idents_seen){
...
var join_node = map__56002__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56002__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56002__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__56072,entity,state_map,idents_seen){
var map__56073 = p__56072;
...
var join_node = map__56073__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56073__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__56079){
...
var node = map__56080__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56080__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__56091 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56091,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var e = temp__5733__auto__;
var temp__5733__auto____$1 = (function (){var G__56098 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__56098) : union_key__GT_query.call(null,G__56098));
})();
if(cljs.core.truth_(temp__5733__auto____$1)){
var target_ast_node = temp__5733__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__56114,current_entity,state_map,idents_seen){
var map__56115 = p__56114;
...
var top_node = map__56115__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56115__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56115__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__4109__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__56125 = nil_nodes;
var G__56125__$1 = (((G__56125 == null))?null:cljs.core.first(G__56125));
if((G__56125__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__56125__$1);
}
})());
} else {
return and__4109__auto__;
...
var G__56127 = result_node__$1;
var G__56127__$1 = (((G__56127 == null))?null:cljs.core.persistent_BANG_(G__56127));
if((G__56127__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__56127__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__56131 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__56131 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__56131,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__56135 = props;
var G__56135__$1 = (((G__56135 == null))?null:cljs.core.meta(G__56135));
if((G__56135__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__56135__$1);
}
});
