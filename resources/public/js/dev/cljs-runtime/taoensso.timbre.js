...
var no_stacktrace_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53120__$1,new cljs.core.Keyword(null,"no-stacktrace?","no-stacktrace?",1701072694));
var stacktrace_fonts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53120__$1,new cljs.core.Keyword(null,"stacktrace-fonts","stacktrace-fonts",830799382));
var map__53121 = data;
...
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53121__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53121__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var msg_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53121__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53121__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53121__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53121__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53121__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53121__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
...
var len__4730__auto___53447 = arguments.length;
var i__4731__auto___53448 = (0);
while(true){
if((i__4731__auto___53448 < len__4730__auto___53447)){
args__4736__auto__.push((arguments[i__4731__auto___53448]));

var G__53449 = (i__4731__auto___53448 + (1));
i__4731__auto___53448 = G__53449;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq53149){
var G__53150 = cljs.core.first(seq53149);
var seq53149__$1 = cljs.core.next(seq53149);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53150,seq53149__$1);
}));
...
return ((function (){var G__53182 = taoensso.timbre.valid_level(x);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__53182) : taoensso.timbre._levels_map.call(null,G__53182));
})() >= (function (){var G__53184 = taoensso.timbre.valid_level(y);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__53184) : taoensso.timbre._levels_map.call(null,G__53184));
})());
});
...
var fexpr__53189 = taoensso.timbre._compile_ns_filter(whitelist,blacklist);
return (fexpr__53189.cljs$core$IFn$_invoke$arity$1 ? fexpr__53189.cljs$core$IFn$_invoke$arity$1(_QMARK_ns) : fexpr__53189.call(null,_QMARK_ns));
}));
/**
...
var vec__53243 = vargs;
var v0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53243,(0),null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__53250 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53250,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__53256 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53256,(0),null);
return v0__$1;
})():null);
var vargs__$2 = (cljs.core.truth_(fmt_msg_QMARK_)?taoensso.timbre.vrest(vargs__$1):vargs__$1);
...
var instant_53492 = taoensso.encore.now_dt();
var context_53493 = taoensso.timbre._STAR_context_STAR_;
var vargs_53494 = cljs.core.deref(vargs_);
var vec__53291_53495 = taoensso.timbre.parse_vargs(_QMARK_err,msg_type,vargs_53494);
var _QMARK_err_53496__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53291_53495,(0),null);
var _QMARK_meta_53497 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53291_53495,(1),null);
var _QMARK_msg_fmt_53498 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53291_53495,(2),null);
var vargs_53499__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53291_53495,(3),null);
var data_53500 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__4120__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?err_","?err_",789480858),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891)],[instant_53492,config,vargs_53499__$1,_QMARK_file,(function (){var fexpr__53315 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null);
return (fexpr__53315.cljs$core$IFn$_invoke$arity$1 ? fexpr__53315.cljs$core$IFn$_invoke$arity$1(level) : fexpr__53315.call(null,level));
})(),_QMARK_ns_str,level,_QMARK_err_53496__$1,context_53493,_QMARK_line,(new cljs.core.Delay((function (){
return _QMARK_err_53496__$1;
}),null)),_QMARK_meta_53497,_QMARK_msg_fmt_53498]));
var _QMARK_data_53501 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,mf){
...
}),data_53500,new cljs.core.Keyword(null,"middleware","middleware",1462115504).cljs$core$IFn$_invoke$arity$1(config));
var temp__5735__auto___53514 = _QMARK_data_53501;
if(cljs.core.truth_(temp__5735__auto___53514)){
var data_53515__$1 = temp__5735__auto___53514;
var map__53319_53516 = data_53515__$1;
var map__53319_53517__$1 = (((((!((map__53319_53516 == null))))?(((((map__53319_53516.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53319_53516.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53319_53516):map__53319_53516);
var vargs_53518__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53319_53517__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_53519__$2 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data_53515__$1,new cljs.core.Keyword(null,"vargs_","vargs_",552132148),(new cljs.core.Delay((function (){
return vargs_53518__$2;
}),null)));
var data_53520__$3 = taoensso.encore.assoc_nx.cljs$core$IFn$_invoke$arity$variadic(data_53519__$2,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
var G__53327 = msg_type;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__53327)){
return "";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"p","p",151049309),G__53327)){
return taoensso.timbre.str_join(vargs_53518__$2);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),G__53327)){
if(typeof _QMARK_msg_fmt_53498 === 'string'){
} else {
...
return taoensso.encore.format_STAR_(_QMARK_msg_fmt_53498,vargs_53518__$2);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53327)].join('')));
...
return cljs.core.hash(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [callsite_id,_QMARK_msg_fmt_53498,cljs.core.get.cljs$core$IFn$_invoke$arity$3(_QMARK_meta_53497,new cljs.core.Keyword(null,"hash","hash",-13781596),vargs_53518__$2)], null));
}),null))], 0));
var output_fn1_53521 = taoensso.encore.memoize_(cljs.core.get.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
return cljs.core.not((function (){var G__53338 = cljs.core.force(new cljs.core.Keyword(null,"hash_","hash_",-827203612).cljs$core$IFn$_invoke$arity$1(data_53520__$3));
return (rl_fn.cljs$core$IFn$_invoke$arity$1 ? rl_fn.cljs$core$IFn$_invoke$arity$1(G__53338) : rl_fn.call(null,G__53338));
})());
}
})();
if(rate_limit_okay_QMARK_){
var map__53341 = appender;
...
var apfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53341__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53341__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
...
while(true){
if((i__4731__auto___53563 < len__4730__auto___53561)){
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq53412){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq53412));
}));
