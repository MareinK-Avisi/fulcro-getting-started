 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__53702){
var vec__53705 = p__53702;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53705,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53705,(1),null);
var ref = vec__53705;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__53711){
var vec__53712 = p__53711;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53712,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53712,(1),null);
var ref = vec__53712;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__53723){
var map__53725 = p__53723;
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53725__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__53754,entity,state_map,parent_node,idents_seen){
...
var join_node = map__53755__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53755__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53755__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Loop detected in data graph at ",entity,". Recursive query stopped."], null);
}),null)),null,1270249965);
} else {
}
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__53799,entity,state_map,idents_seen){
...
var join_node = map__53800__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53800__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__53807){
...
var node = map__53808__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53808__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__53814 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53814,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var e = temp__5733__auto__;
var temp__5733__auto____$1 = (function (){var G__53819 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__53819) : union_key__GT_query.call(null,G__53819));
})();
if(cljs.core.truth_(temp__5733__auto____$1)){
var target_ast_node = temp__5733__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__53826,current_entity,state_map,idents_seen){
var map__53827 = p__53826;
var map__53827__$1 = (((((!((map__53827 == null))))?(((((map__53827.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53827.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53827):map__53827);
var top_node = map__53827__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53827__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53827__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__4109__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__53833 = nil_nodes;
var G__53833__$1 = (((G__53833 == null))?null:cljs.core.first(G__53833));
if((G__53833__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__53833__$1);
}
})());
} else {
return and__4109__auto__;
...
var G__53836 = result_node__$1;
var G__53836__$1 = (((G__53836 == null))?null:cljs.core.persistent_BANG_(G__53836));
if((G__53836__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__53836__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__53846 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__53846 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__53846,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__53848 = props;
var G__53848__$1 = (((G__53848 == null))?null:cljs.core.meta(G__53848));
if((G__53848__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__53848__$1);
}
});
