...
var G__42185 = devtools.prefs.pref(v);
v = G__42185;
continue;
} else {
return v;
...
var or__4120__auto__ = (function (){try{if((!((value == null)))){
...
}catch (e42109){var _e__40683__auto__ = e42109;
return false;
}})();
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
var or__4120__auto____$1 = (function (){try{if((!((value == null)))){
...
}catch (e42116){var _e__40683__auto__ = e42116;
return false;
}})();
...
var and__4109__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__4109__auto__)){
...
var or__4120__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
...
var and__4109__auto__ = (function (){var or__4120__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
...
var vec__42137 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42137,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42137,(1),null);
...
var and__4109__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__4109__auto__)){
...
return cljs.core.some((function (p1__42142_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42142_SHARP_);
}),template);
});
